...
/*
    ...
    internal class MyServiceHost
    {
        ...
        internal static void StartService()
        {
            ...
            myServiceHost = new ServiceHost(typeof(HelloIndigo.service1), baseAddress);
    ...
    <system.serviceModel>
    <services>
         <service name="HelloIndigo.service1">
           <endpoint contract="HelloIndigo.IService1" binding="wsHttpBinding"/>
         </service>
       </services>
    </system.serviceModel>
