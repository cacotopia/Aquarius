...
/*
    ...
    internal class MyServiceHost
    {
        ...
        internal static void StartService()
        {
            ...
            myServiceHost = new ServiceHost(typeof(MediaManager.service1), baseAddress);
    ...
    <system.serviceModel>
    <services>
         <service name="MediaManager.service1">
           <endpoint contract="MediaManager.IService1" binding="wsHttpBinding"/>
         </service>
       </services>
    </system.serviceModel>
