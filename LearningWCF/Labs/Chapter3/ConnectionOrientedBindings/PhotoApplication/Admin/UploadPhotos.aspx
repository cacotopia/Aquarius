...
<asp:button id="cmdUploadPhoto" runat="server" Text="Upload Photo" OnClick="cmdUploadPhoto_Click" ></asp:button>&nbsp;
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetCategories" TypeName="PhotoManager.PhotoUploadUtil"></asp:ObjectDataSource>
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" InsertMethod="SavePhoto" TypeName="PhotoManager.PhotoUploadUtil" OldValuesParameterFormatString="original_{0}" SelectMethod="GetPhotos">
        <InsertParameters>
